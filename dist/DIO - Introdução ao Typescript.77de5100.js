...
function somatipo(a, b) {
  return a + b;
}

console.log(somatipo(5, 10)); //  USANDO A INTERFACE BASE
...
input.addEventListener('input', function (event) {
  console.log('Digitei!'); //  PARA APARECER TODOS OS MÉTODOS 
...
inputt.addEventListener('input', function (event) {
  ...
  console.log(i.value); //  PARA APARECER TODOS OS MÉTODOS 
});
...
//# sourceMappingURL=/DIO%20-%20Introdução%20ao%20Typescript.77de5100.js.map